package com.muath.flickrsearches;
/**
File name: MainAcitivty.java
Author: Muath Alqurashi
Email Address: mhalqurashi@suffolk.edu
Last day of modification: April 23, 2015
Description: This app let users save flicker queries. 
*/
...
public class MainActivity extends ListActivity {
	...
	OnItemClickListener itemClickListener = new OnItemClickListener()
	{
		...
		public void onItemClick(AdapterView<?> parent, View view, 
			...
			String urlString = getString(R.string.flickrSearchUrl) +
	...
	private void shareSearches(String tag) {
		String urlString = getString(R.string.flickrSearchUrl) + 
				Uri.encode(savedSearches.getString(tag, ""), "UTF-8");
	...
	OnItemLongClickListener itemLongClickListener =
			new OnItemLongClickListener() 
			{
						...
						int position, long id)
				{
					...
					builder.setItems(R.array.dialgo_items, 
						new DialogInterface.OnClickListener()
						{	
							@Override
